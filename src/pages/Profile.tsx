            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 max-w-2xl text-sm text-gray-500">
                  {isEditing ? 'Edit your personal details' : 'Personal details and role'}
                </p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmitPw(onChangePassword)}>
            <div className="border-t border-gray-200 px-4 py-5 space-y-4">
              ...
              <div>
                ...
                <input
                  type="password"
                  {...registerPw('new_password', { required: 'New password is required', minLength: { value: 6, message: 'At least 6 characters' } })}
                  className="w-full px-3 py-2 border rounded-md"
                />
              ...
              <div>
                ...
                <input
                  type="password"
                  {...registerPw('confirm_password', { required: 'Please confirm new password' })}
                  className="w-full px-3 py-2 border rounded-md"
                />
